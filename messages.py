...
donate_description = _("This is a voluntary donation to my creator.")

russia_donate_message = _(
    "To transfer money tap the first button, \
you will be redirected to the payment page"
)

successfull_payment = _(
...
reg_update_success = _(
    "Your sheet successfully changed!\n\n\
Don't forget to select the main currency and its format in /currency \
and set bots language in /language"
)

reg_forget_warning = _("Are you sure? After that you have to /register again to use me")
...
ask_format = _("Please select a currency format that suits you best")
